...
import { Search, Filter, X, ChevronUp, ChevronDown, Download, AlertCircle, Loader2 } from 'lucide-react';
import toast from 'react-hot-toast';
import { usePDF } from 'react-to-pdf';
import VerifiedIcon from '../../components/VerifiedIcon';
import VettingRequests from './VettingRequests';
...
export default function Vetting() {
  ...
  return (
    <Routes>
      <Route index element={<VettingDatabase />} />
      <Route path="requests" element={<VettingRequests />} />
